...
export const BugIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h2" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16 8h2a2 2 0 012 2v8a2 2 0 01-2 2h-2" />
    </svg>
);

export const MessageSquareIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72A2.122 2.122 0 016 19.182V14.9c0-.969.616-1.813 1.5-2.097m11.25 0c-.884-.284-1.5-1.128-1.5-2.097V6.318a2.122 2.122 0 00-2.121-2.121H6.318a2.122 2.122 0 00-2.121 2.121v4.286c0 .969.616 1.813 1.5 2.097" />
    </svg>
);

// New unified icon for Logo and Bot
const newIcon = (
...
export const BotIcon: React.FC<IconProps> = ({ className }) => (
    React.cloneElement(newIcon, { className })
);
